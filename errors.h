...
#define PRINT_USAGE_ERROR(arg) \
    switch (errno) {\
        ...
        case 0: \
            ...
            fprintf(stderr, "Правильное использование: cclipper путь/к/директории/проекта .расширения .имён .файлов\nЛибо cclipper .расширения .имён .файлов. В таком случае директорией проекта будет считаться директория, из которой была запущена утилита cclipper\nЛибо cclipper. В таком случае будет произведена работа с файлами с любыми расширениями в директории, откуда запускается cclipper"); break; \
    };
